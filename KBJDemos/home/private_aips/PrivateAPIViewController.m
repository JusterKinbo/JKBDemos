...
#define appName_PrivateAPIViewController @"appName"
#define appBundleIdentifier_PrivateAPIViewController @"appBundleIdentifier"
#define cellIdentifier_PrivateAPIViewController @"cellIdentifier"


@interface PrivateAPIViewController ()<UITableViewDelegate,UITableViewDataSource>
...
{
//    [super loadView];
    self.view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, ScreenWith, ScreenHeight-49)];
...
{
    UITableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier_PrivateAPIViewController];
    if(!cell)
    {
        cell = [[UITableViewCell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:cellIdentifier_PrivateAPIViewController];
    }
    cell.textLabel.text = _data[indexPath.row][appName_PrivateAPIViewController];
    cell.detailTextLabel.text = _data[indexPath.row][appBundleIdentifier_PrivateAPIViewController];
    return cell;
}
#pragma --mark 私有aip
- (void)showAppsInfo {
