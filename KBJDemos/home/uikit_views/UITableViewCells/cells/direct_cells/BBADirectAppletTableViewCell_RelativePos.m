//
//  BBADirectAppletTableViewCell_RelativePos.m
//  KBJDemos
//
...
#import "BBADirectAppletTableViewCell_RelativePos.h"
...
@interface BBADirectAppletTableViewCell_RelativePos()
...
@implementation BBADirectAppletTableViewCell_RelativePos
...
- (void)updateUI
{
    ...
    //验证比例、宽高、优先级
        ...
        [_personNumber mas_makeConstraints:^(MASConstraintMaker *make) {//相对于name
            ...
            make.width.greaterThanOrEqualTo(@50).with.priorityHigh();
            make.right.equalTo(self->_bottomVerticalLine.mas_left).mas_offset(-10);
        }];
    
        [_bottomVerticalLine mas_makeConstraints:^(MASConstraintMaker *make) {
            make.height.mas_equalTo(12);
            make.centerY.equalTo(self->_personNumber.mas_centerY);
