...
/**
 ...
 该方法可以替代normal collection vc里面的invalidate
 */
...
/**
 UICollectionViewLayoutInvalidationContext 声明了哪一步分需要更新，通过它可以进行布局优化
 */
...
{
    NSLog(@"****** MovementOfItems %@",indexPaths);
...
{
    NSLog(@"****** PreferredLayoutAttributes %@",preferredAttributes);
...
{
    NSLog(@"****** MovingItems %@",targetIndexPaths);
